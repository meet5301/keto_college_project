...
<html lang="en">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="bw">Beach Wedding</a>
                              </li>
                              <li class="nav-item">
  ...
  <div class="form-container">
    ...
    <form id="mainForm">
      <label><input type="checkbox" name="service" value="houseBoat"> Cruise ship Wedding</label>
      <label><input type="checkbox" name="service" value="carDecoration"> wedding cars</label>
      <label><input type="checkbox" name="service" value="liveStreaming"> Live Streaming Services</label>
      <label><input type="checkbox" name="service" value="weddingDance"> Wedding Dance</label>
