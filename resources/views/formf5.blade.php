...
<html lang="en">
  ...
  <div class="form-container">
    ...
    <form id="mainForm">
      <label><input type="checkbox" name="service" value="houseBoat"> House and Boat Decoration</label>
      <label><input type="checkbox" name="service" value="carDecoration"> Car Decoration</label>
      <label><input type="checkbox" name="service" value="liveStreaming"> Live Streaming Services</label>
      <label><input type="checkbox" name="service" value="weddingDance"> Wedding Dance (Gujarat)</label>
      <label><input type="checkbox" name="service" value="stageDecoration"> Stage Decoration</label>
      <button type="button" onclick="showSelectedForms()">Submit</button>
    </form>

    <div id="houseBoatForm" class="form-section">
      <h2>House and Boat Decoration</h2>
