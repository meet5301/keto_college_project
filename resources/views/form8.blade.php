...
<html lang="en">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="dw">Destination Wedding</a>
                              </li>
                              <li class="nav-item">
  ...
  <div class="form-container">
    ...
    <form id="mainForm">
      <label><input type="checkbox" name="service" value="houseBoat"> Ahmedabad</label>
      <label><input type="checkbox" name="service" value="carDecoration"> Jamnagar</label>
      <label><input type="checkbox" name="service" value="liveStreaming"> Vadodara</label>
      <label><input type="checkbox" name="service" value="weddingDance"> Surat</label>
      <label><input type="checkbox" name="service" value="stageDecoration"> Rajkot</label>
