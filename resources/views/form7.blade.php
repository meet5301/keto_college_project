...
<html lang="en">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="pp">Private Parties</a>
                              </li>
                              <li class="nav-item">
  ...
  <div class="form-container">
    ...
    <form id="mainForm">
      <label><input type="checkbox" name="service" value="houseBoat"> Theme Parties</label>
      <label><input type="checkbox" name="service" value="carDecoration"> Get Together</label>
      <label><input type="checkbox" name="service" value="liveStreaming"> Alumni Meet</label>
      <label><input type="checkbox" name="service" value="weddingDance"> Anniversary Parties</label>
      <label><input type="checkbox" name="service" value="stageDecoration"> Birthday Parties</label>
